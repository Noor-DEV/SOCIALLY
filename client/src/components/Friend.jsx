...
const Friend = ({ friendId: friend_id, name, subtitle, user_picture_path,updateFriends=null }) => {
  ...
  const patchFriend = async () => {
    const PATCH_URL = `http://localhost:8080/users/${userId}/${friend_id}`;
